...
type Quality = "橙" | "紫" | "藍"
type Profession = "盾" | "槍" | "弓" | "騎"

const factions: Faction[] = ["魏", "蜀", "吳", "群"]
const qualities: Quality[] = ["橙", "紫", "藍"]
const professions: Profession[] = ["盾", "槍", "弓", "騎"]
...
export default function GeneralGrid({ generals }: { generals: General[] }) {
  ...
  const [selectedProfession, setSelectedProfession] = useState<Profession | "全部">("全部");
  ...
  return (
    <div className="py-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        { (selectedFaction !== "全部" || selectedQuality !== "全部" || selectedProfession !== "全部" || searchTerm) && (
          <button 
            onClick={() => { setSelectedFaction("全部"); setSelectedQuality("全部"); setSelectedProfession("全部"); setSearchTerm(""); }}
