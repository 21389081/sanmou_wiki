        ...
        <nav className='fixed top-0 left-0 right-0 z-50 bg-background'>
            <div className='max-w-7xl mx-auto px-4 h-16 flex items-center justify-between relative z-50 bg-background'>
                ...
                <div className='flex items-center gap-4'>
                                    ...
                                    <div className='space-y-1'>
                                        {filteredGenerals.slice(0, 2).map((g) => (
                                            <Link
                                                ...
                                                className='flex items-center gap-2 p-1.5 hover:bg-white/5 rounded'
                                            >
                    ...
                    {/* Mobile Menu Button */}
                    <button
                        className='xl:hidden text-foreground p-2 hover:bg-white/5 rounded-lg transition-colors relative z-50'
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className='absolute top-16 left-0 right-0 bg-background z-40 xl:hidden flex flex-col p-6 shadow-2xl overflow-hidden'
                    >
                        {/* Mobile Search */}
                                        ...
                                        <div className='space-y-1'>
                                            {filteredGenerals.slice(0, 3).map((g) => (
                                                <Link
                                                    ...
                                                    className='flex items-center gap-2 p-2 hover:bg-white/5 rounded'
                                                >
                                                    <div className='relative w-6 h-6 rounded overflow-hidden bg-white/5'>
                                                        <Image
                                                            src={g.avatar}
